...
@Entity("person_temp", { schema: "sw3k_tm" })
export class PersonTemp {
  ...
  @Column("varchar", { name: "AvoidObjUnit", nullable: true, length: 255 })
  avoidObjUnit: string | null;

  @Column("varchar", { name: "IsExperience", nullable: true, length: 255 })
  isExperience: string | null;
